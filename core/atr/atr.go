...
//
// Встраивает core.AttrMarker, поэтому автоматически реализует все
...
// открывающего тега через core.RenderChildren/core.RenderVoid. Метод нужен
// только для удовлетворения core.Node.
