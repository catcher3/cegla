...
// class="...". Реализует core.Attribute напрямую (Style — слайс, поэтому не
// может встроить core.AttrMarker как структурное поле — методы продублированы
...
//	}
//
// core.RenderChildren распознаёт Style как core.Attribute с Key()=="class"
