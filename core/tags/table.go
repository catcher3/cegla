...
// Table типизирован как []core.TableChild, а не []core.FlowContent —
...
type Table []core.TableChild

type Caption []core.FlowContent
type ColGroup []Col
type Col []core.Attribute // void-элемент (только атрибут span), без детей
type THead []TR
type TBody []TR
type TFoot []TR
type TR []core.TableRowContent
type TD []core.FlowContent // содержимое ячейки — обычный Flow
type TH []core.FlowContent // + атрибут scope, содержимое — обычный Flow
