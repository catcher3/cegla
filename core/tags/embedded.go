...
type Img []core.Attribute
type Embed []core.Attribute
type Source []core.Attribute // только внутри picture/video/audio
type Track []core.Attribute  // только внутри video/audio
...
// ([]core.FlowContent) — см. обсуждение архитектуры. Это единственное
// известное ограничение системы типов, не баг.

type Object []core.FlowContent
type Video []core.FlowContent // + Source/Track внутри
type Audio []core.FlowContent // + Source/Track внутри
type Canvas []core.FlowContent
...
type Svg []core.Attribute
type MathML []core.Attribute
