...
// "теги — это слайсы": они, как и core.Text, могут содержать ТОЛЬКО текст
...
// string-типе.
type Title []core.PhrasingContent
type Script []core.PhrasingContent
type StyleTag []core.PhrasingContent
...
type Base []core.Attribute
type Link []core.Attribute
type Meta []core.Attribute
...
type NoScript []core.FlowContent
