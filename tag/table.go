...
type Table []TableChild

type Caption Flow
type ColGroup []Col
type Col Attrs // void-элемент (только атрибут span), без детей
type THead []TR
type TBody []TR
type TFoot []TR
type TR []TableRowContent
type TD Flow // содержимое ячейки — обычный Flow
type TH Flow // + атрибут scope, содержимое — обычный Flow
