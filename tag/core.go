...
func (Metadata) Name() string { return "#fragment" }
...
func (Flow) Name() string { return "#fragment" }
func (Flow) IsFlow()      {}
func (tg Flow) Render(ctx context.Context, w *bufio.Writer) error {
	for _, child := range tg {
		if err := child.Render(ctx, w); err != nil {
			return err
		}
	}
